...
<head>
 ...
 <nav>
        ...
        <label class="logo"><a href="../admin/paymentt.php">Payment</a></label>
        <ul>
            ...
            <li><a class="active" href="../admin/paymentt.php">Payment</a></li>
...
<?php while($row = mysqli_fetch_array($results)) {?>
    ...
    <tr>
        ...
        <td><?php echo $row['tamnt']; ?></td>
        

        <td>
        <a href="print.php?pri=<?php echo $row['pid']; ?>" class="btn btn-success" name="print">
